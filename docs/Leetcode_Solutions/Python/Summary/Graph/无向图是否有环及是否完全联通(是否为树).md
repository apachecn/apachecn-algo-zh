## 如果一个图完全联通且没有环，那么它就是一棵树(思想来源于261题)
...
n = 4
edges = [[0, 1], [2, 3]]
print('Does graph has cycle? : ', Solution(n, edges).hasCycle())  # False
print('Does graph has fully connected? : ', Solution(n, edges).fullyConnected())  # False
print()
n = 5
edges = [[0, 1], [0, 2], [0, 3], [1, 4]]
print('Does graph has cycle? : ', Solution(n, edges).hasCycle())  # False
print('Does graph has fully connected? : ', Solution(n, edges).fullyConnected())  # True
```
